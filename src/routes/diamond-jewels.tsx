  ...
  return (
    <CategoryPage
      ...
      bentoTiles={[
        ...
        { type: "image", title: "Cocktail Earrings", image: diamondImg(2), body: "Statement silhouettes for evening wear." },
        ...
        { type: "image", title: "Everyday Sparkle", image: diamondImg(5), body: "Clean, versatile diamond pieces for gifting and daily wear." },
