...
export const Route = createFileRoute("/shop/ladies")({
  head: () => ({
    meta: [
      { title: "Ladies — TWILA" },
      { name: "description", content: "Timeless silhouettes, written in precious metal — bridal, cocktail and daily edits." },
      { property: "og:image", content: BANNERS.ladies.image },
    ],
  }),
  component: () => (
    <CategoryPage
